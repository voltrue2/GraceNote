...
Fusion.prototype.onOpen = function (params, cb) {
	...
	for (var i in this.list){
		preloader.addImage(this.list[i]);
	}
	preloader.addImage(params.creatureA);
	preloader.addImage(params.creatureB);
	preloader.addImage(params.creatureResult);
	var self = this;
